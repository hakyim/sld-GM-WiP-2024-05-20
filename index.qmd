...
<!-- begin ----------------------------- -->
## Identifying TF binding altered by GWAS variants  {background-image=assets/slide-background.svg .nostretch }


![](assets/ovarian-tfxcan.png)
...
<!-- begin ----------------------------- -->
## Context specific expression prediction (Saideep Gona){background-image=assets/slide-background.svg .nostretch }
